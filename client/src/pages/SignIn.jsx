...
const SignIn = () => {
  ...
  return (
    <div>
      <h1 className='text-3xl text-center font-semibold mt-7 mb-3 text-slate-700'>Sign-In</h1>
      <form onSubmit={hadleSubmit} className='flex flex-col max-w-[600px] mx-auto gap-2 border border-slate-100 p-10 rounded-xl'>
